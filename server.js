...
const DB_URI = process.env.MONGODB_URI || 'mongodb+srv://jsjhshjsjhsh27_db_user:oBkPjDgdDFwNW4Vk@cluster0.jkpmhai.mongodb.net/tatapay_db?retryWrites=true&w=majority';

const JWT_SECRET = process.env.JWT_SECRET || 'moneypay-jwt-secret';
const ADMIN_KEY = process.env.ADMIN_KEY || 'moneypay-admin-key';
